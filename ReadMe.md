...
| DNS Lookups | `dig -x 8.8.8.8`, `dig @8.8.8.8 domainName`, `dig @8.8.8.8 +norecurse domainName`, `dig @8.8.8.8 +trace domainName`, `dig +trace any @8.8.8.8 domainName` | `nslookup domainName` using a specific DNS resolver `nslookup domainname 8.8.8.8`| `dig domainName -t soa` |
